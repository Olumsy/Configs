...
let s:nord0_gui = "#2C1A1D"        " Licorice
let s:nord1_gui = "#3A2629"        " Darker variant
let s:nord2_gui = "#4D3A3D"        " Muted transition
let s:nord3_gui = "#6C534E"        " Liver
let s:nord3_gui_bright = "#8A6D69" " Softened bright
let s:nord4_gui = "#DBB3B1"        " Tea rose (red)
let s:nord5_gui = "#E2C3C1"        " Lightened Tea rose
let s:nord6_gui = "#F2DDDC"        " Pale Tea rose
let s:nord7_gui = "#C89FA3"        " Rosy brown
let s:nord8_gui = "#A67F8E"        " Mountbatten pink
let s:nord9_gui = "#B88F9E"        " Blended Mountbatten pink
let s:nord10_gui = "#9F6D7C"       " Muted accent
let s:nord11_gui = "#A67F8E"       " Mountbatten pink
let s:nord12_gui = "#C89FA3"       " Rosy brown
let s:nord13_gui = "#DBB3B1"       " Tea rose (red)
let s:nord14_gui = "#B88F9E"       " Softened accent
let s:nord15_gui = "#D4A8AC"       " Extended rose tone
