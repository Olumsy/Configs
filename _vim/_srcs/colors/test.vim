...
let s:nord0_gui = "#333333"        " Jet (background)
let s:nord1_gui = "#3F3F3F"        " Slightly lighter Jet
let s:nord2_gui = "#4A4A4A"        " Transition shade
let s:nord3_gui = "#5A5A5A"        " Muted contrast
let s:nord3_gui_bright = "#6A6A6A" " Brightened Jet
let s:nord4_gui = "#AFC3B2"        " Ash gray (main text)
let s:nord5_gui = "#BFD0C0"        " Lighter Ash gray
let s:nord6_gui = "#D1E0D1"        " Very light gray-green
let s:nord7_gui = "#89CE94"        " Celadon (accent)
let s:nord8_gui = "#9AD8A4"        " Lightened Celadon
let s:nord9_gui = "#AADFB1"        " Muted Celadon highlight
let s:nord10_gui = "#643173"       " Eminence (primary accent)
let s:nord11_gui = "#7A3D8A"       " Brightened Eminence (error)
let s:nord12_gui = "#9B5AA7"       " Softer warning
let s:nord13_gui = "#B276BA"       " Info tone
let s:nord14_gui = "#91CBA3"       " Success tone
let s:nord15_gui = "#BFD0C0"       " Highlight or subtle UI
