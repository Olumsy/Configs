...
let s:nord0_gui = "#363635"        " Jet
let s:nord1_gui = "#40403F"        " Slightly lighter Jet
let s:nord2_gui = "#4C4C4A"        " Soft transition
let s:nord3_gui = "#595A4A"        " Ebony
let s:nord3_gui_bright = "#6A6B5A" " Brighter Ebony
let s:nord4_gui = "#A1D3AE"        " Green Yellow
let s:nord5_gui = "#C4FF9A"        " Lighter Green Yellow
let s:nord6_gui = "#D7FFC0"        " Very light Green Yellow
let s:nord7_gui = "#81E979"        " Light green
let s:nord8_gui = "#8FBB99"        " Cambridge blue
let s:nord9_gui = "#B0FE76"        " Lightened Cambridge blue
let s:nord10_gui = "#9CDF90"       " Softer light green
let s:nord11_gui = "#81E979"       " Light green
let s:nord12_gui = "#A1D3AE"       " Light Cambridge
let s:nord13_gui = "#B0FE76"       " Green Yellow
let s:nord14_gui = "#9AD68C"       " Balanced soft green
let s:nord15_gui = "#BCE8A8"       " Gentle pastel green
