...
let s:nord0_gui = "#0D160B"        " Night
let s:nord1_gui = "#1A2417"        " Slightly lighter Night
let s:nord2_gui = "#2C3529"        " Muted green-black transition
let s:nord3_gui = "#785589"        " Pomp and Power
let s:nord3_gui_bright = "#8F6B9F" " Brightened Pomp and Power
let s:nord4_gui = "#BB8A89"        " Rosy brown
let s:nord5_gui = "#C99B9A"        " Lightened Rosy brown
let s:nord6_gui = "#DAB1B0"        " Very light Rosy brown
let s:nord7_gui = "#AC7B7D"        " Old rose
let s:nord8_gui = "#977390"        " Mountbatten pink
let s:nord9_gui = "#A87FA0"        " Brighter Mountbatten pink
let s:nord10_gui = "#B88BAF"       " Muted soft pink
let s:nord11_gui = "#AC7B7D"       " Old rose (error/accent)
let s:nord12_gui = "#BB8A89"       " Rosy brown (warning)
let s:nord13_gui = "#C99B9A"       " Light Rosy brown (info)
let s:nord14_gui = "#A87FA0"       " Pink tone (success)
let s:nord15_gui = "#B78CA5"       " Highlight/accent pastel
