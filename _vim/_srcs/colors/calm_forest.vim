...
hi CursorLine       guisp=NONE guifg=NONE  guibg=#343434 ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi VertSplit        guisp=NONE guifg=#787575 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=bold
...
hi IncSearch        guisp=NONE guifg=#D7B866 guibg=#647F4F ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi CursorLineNr     guisp=NONE guifg=#CFFF3E guibg=NONE ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi NonText          guisp=NONE guifg=#384545 guibg=NONE ctermfg=131 ctermbg=234 gui=NONE cterm=NONE
hi Pmenu            guisp=NONE guifg=#384545 guibg=#151515 ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi PmenuSel         guisp=NONE guifg=#384545 guibg=#101010 ctermfg=231 ctermbg=234 gui=NONE cterm=bold
...
hi Search           guisp=NONE guifg=#111111 guibg=#F5F538 ctermfg=231 ctermbg=234 gui=bold cterm=bold,italic
...
hi Character      guisp=NONE guifg=#B178EB guibg=NONE ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi Operator       guisp=NONE guifg=#C8D249 guibg=NONE ctermfg=116 ctermbg=234 gui=bold cterm=bold
hi Keyword        guisp=NONE guifg=#86CD33 guibg=NONE ctermfg=67  ctermbg=234 gui=bold cterm=bold
